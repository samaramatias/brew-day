...
(function () {
    ...
    /**
     * Controller of the should-brew page.
     */
    recipeModule.controller('ShouldBrewController', ['$q', '$state', 'RecipeService', 'ToastService', 'Inventory', 'InventoryService', 'Brew', 'BrewService', 'ModalService',
